...
public class MainMenu extends Screen {
    ...
    public MainMenu() {
        ...
        ButtonTexture bt = new ButtonTexture(ResourceLoader.loadTexture("button"),
                ...
                new float[]{0,31f/256,242f/256,31f/256},    //Down state
                new float[]{0,62f/256,242f/256,31f/256}     //Hover state
        );

        TickTexture tt = new TickTexture(ResourceLoader.loadTexture("tick"),
                new float[]{0,0,64f/128,64f/128},
                new float[]{64f/128,0,64f/128,64f/128},
                new float[]{0,64f/128,64f/128,64f/128}
        );

        InputTexture it = new InputTexture(ResourceLoader.loadTexture("inputButton"),
                new float[]{0,0,201f/256,33f/126},
                new float[]{0,32.25f/126,201f/256,33f/126},
                new float[]{0,65f/126,201f/256,33f/126}
        );

        SliderTexture st = new SliderTexture(ResourceLoader.loadTexture("slider"),
                new float[]{0,11f/256, 65f/256, 65f/256},
                new float[]{130f/256,11f/256, 65f/256, 65f/256},
                new float[]{65f/256,11f/256, 65f/256, 65f/256},
                new float[]{0,0,201f/256,11f/256}
        );
