package com.rugieCorp.engine.physics.quadTree;
...
public class QuadTree {
   ...
   * @param aabb the size of the current quadTree
   */
  public QuadTree(TreeEntry contains, AABB aabb){
   ...
   */
  public void insert(TreeEntry entry) throws Exception {
   ...
   */
  public List<TreeEntry> getEntry(AABB aabb){

    List<TreeEntry> res = new ArrayList<>();
